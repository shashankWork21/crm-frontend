            ...
            <div className="prose max-w-none">
              ...
              <div className="bg-blue-50 border-l-4 border-blue-500 p-6 mb-8">
                ...
                <ul className="text-blue-700 space-y-1">
                  <li>• 15-day refund window from date of purchase</li>
                  <li>• 3-5 business day processing time</li>
                  <li>• Full refund to original payment method</li>
                  <li>• No questions asked policy within eligibility period</li>
                </ul>
              </div>
              ...
              <section className="mb-8">
                ...
                <div className="space-y-4">
                  <p className="text-slate-700 leading-relaxed">
                    ...
                    <strong className="text-blue-600">15 calendar days</strong>{" "}
                    ...
                    <div className="space-y-3">
                      <div className="flex items-center">
                        ...
                        <span className="text-green-700">
                          <strong>0-24 hours:</strong> Initial review and
                          approval
                        </span>
                      </div>
                      <div className="flex items-center">
                        <div className="w-4 h-4 bg-green-500 rounded-full mr-3"></div>
                        <span className="text-green-700">
                          <strong>1-2 business days:</strong> Refund initiated
                        </span>
                      </div>
                      <div className="flex items-center">
                        <div className="w-4 h-4 bg-green-500 rounded-full mr-3"></div>
                        <span className="text-green-700">
                          <strong>3-5 business days:</strong> Amount credited to
                          your account
                        </span>
                      </div>
                    </div>
