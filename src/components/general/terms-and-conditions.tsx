    ...
    <div className="max-w-4xl mx-auto px-6">
      <div className="bg-white rounded-lg shadow-lg overflow-hidden">
        ...
        <div className="bg-black-900 px-8 py-12">
          ...
          <p className="text-rich-black text-lg">
        ...
        <div className="px-8 py-8">
          <div className="prose max-w-none">
            ...
            <div className="bg-gray-50 border-l-4 border-powder-blue p-6 mb-8">
              <h3 className="text-lg font-semibold text-rich-black mb-2">
                Agreement Overview
              </h3>
              <ul className="text-rich-black space-y-1">
                <li>
              ...
              <div className="space-y-4">
                <div className="grid md:grid-cols-2 gap-6">
                  <div className="bg-slate-50 p-4 rounded-lg">
                    ...
                    <ul className="text-rich-black text-sm space-y-2">
                      <li>
            ...
            <section className="mb-8">
              ...
              <div className="space-y-4">
                <p className="text-rich-black">
                  You agree to use the SmartAlgorhythm CRM platform responsibly
                ...
                <div className="p-6 rounded-lg">
                  ...
                  <div className="grid md:grid-cols-3 gap-4">
                    <div className="text-center">
                      <div className="text-2xl font-bold text-rich-black">
                        99.9%
                      </div>
                    ...
                    <div className="text-center">
                      ...
                      <div className="text-sm text-rich-black">Monitoring</div>
                    </div>
                  </div>
                </div>
                <p className="text-rich-black text-sm">
            ...
            <section className="mb-8">
              ...
              <div className="space-y-4">
                <div className="rounded-lg p-6">
                  ...
                  <p className="text-rich-black text-sm mb-3">
